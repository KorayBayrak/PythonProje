...
def Kayit_ol():
    global Mail, KullaniciAdi, Sifre, Ad, Soyad, kullanıcılar
    print("\n***Kayit ol***\n")
    Ad = input("Adiniz: ")
...
def Giris_yap():
    global Mail, KullaniciAdi, Sifre, Ad, Soyad, kullanıcı
    print("\n***Uye Girisi***\n")
...
def Yonetici_girisi():
    global kullanıcılar,stok
    print("\n***Yonetici Giris Ekranı***\n")
    YoneticiAdi = input("Yonetici Kullanici Adi: ")
    YoneticiSifre = input("Yonetici Sifresi: ")
    while True:
        if (YoneticiAdi == "admin" and YoneticiSifre == "123456"):
            print("Giris Basarili. Yonetici Menusune Yonlendiriliyorsunuz...")
            print("******Yönetici Menüsü******")
            print("1-Kayıtlı Kullanıcı Bilgilerini Göster\n2-Stok Durumunu Görüntüle")
            secim_yonetici = int(input("Seçiminizi yapınız: "))
            if secim_yonetici == 1:
                print("******Kayıtlı Kullanıcı Bilgileri******")
                for kullanıcı in kullanıcılar:
                    print("-----------------------")
                    print("Kullanici Adi:", kullanıcı["kullanici_adi"])
                    print("Mail Adresi:", kullanıcı["mail"])
                    print("Ad:", kullanıcı["ad"])
                    print("Soyad:", kullanıcı["soyad"])
                    print("-----------------------")
            elif secim_yonetici == 2:
                print("*****Stok Durumunu Görüntüle*****\n")
                for i in stok:
                  print(i,"Ürününden",stok[i],"tane stoklarda mevcuttur.")
            else:
                print("Geçersiz seçim.")
            break
        else:
